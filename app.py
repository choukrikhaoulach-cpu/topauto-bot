...
def enregistrer(tel, langue, data):
    # BUG FIX: 'tel' est le parametre, pas 'telephone'
    try:
        svc = gsheets()
        if not svc:
            return False
        ...
        # BUG FIX: indentation correcte du if/else
        if idx:
            svc.spreadsheets().values().update(
                spreadsheetId=sid,
                range=f"{sn}!A{idx}:P{idx}",
...
# ============================================================
BOUTON_ACTIONS = {
    "véhicules": "MENU_VEH", "vehicules": "MENU_VEH",
    "sav & atelier": "SAV", "sav &amp; atelier": "SAV",
    "autre demande": "MENU_AUTRE", "autre": "MENU_AUTRE",
    "véhicules neufs": "VN", "vehicules neufs": "VN",
    "véhicules occasion": "VO", "vehicules occasion": "VO",
    "essai gratuit": "ESSAI",
    "demande facture": "FACTURE",
    "mainlevée": "MAINLEVEE", "mainlevee": "MAINLEVEE",
    "réclamation": "RECLAMATION", "reclamation": "RECLAMATION",
    "prendre rdv": "RDV_SAV",
